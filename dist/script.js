...
var forms = function forms() {
  ...
  var postDataXML = function postDataXML(url, body) {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains(tabSelector.replace(/\./g, '')) || target && target.parentNode.classList.contains(tabSelector.replace(/\./g, ''))) {
